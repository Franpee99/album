    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('albumes.store') }}" class="max-w-sm mx-auto"
                ...
                <div class="mb-5">
                    <label for="canciones" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Añadir canciones (mantén presionada la tecla Ctrl o Cmd para seleccionar varias opciones)
                    </label>
                    <select name="canciones[]" id="canciones" multiple class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
